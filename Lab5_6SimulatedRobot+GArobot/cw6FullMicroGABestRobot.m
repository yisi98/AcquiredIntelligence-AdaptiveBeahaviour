...
range1= -4; %range for genotype values so when using rand, it will generate value within this range
range2= 4;
...
for i = 1:100000  %10000 generations
...
pos = simple_agent(100,[1; 1],90,genotype,false);
sum = 0;
T = size(pos,2);
for time = 1:T
    x= pos(1,T);
